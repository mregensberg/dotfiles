...
bot "Hi! I'm going to install tooling. Here we go..."
...
bot "After applying iTerm font settings, Please reboot and return to run the application and OS specific configurator (sheldon.sh)"
